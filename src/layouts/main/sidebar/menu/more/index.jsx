...
export default function More() {
  return (
    <Popover className="relative">
      <Popover.Button className="block py-[3px] group -ml-2.5 outline-none ">
        <div className="inline-flex items-center p-3 opacity-90 tracking-wide group-hover:bg-[#eff3f41a] duration-300  gap-5  rounded-full">
          ...
          <div className="text-xl  pr-5">Daha fazla</div>
        </div>
      </Popover.Button>
      <Popover.Panel className=" overflow-hidden w-[318px] cursor-pointer absolute -top-[250px] left-0 bg-black rounded-xl  shadow-more-shadow">
        <Link
          to="/"
          className="w-full h-14 flex items-center px-4 hover:bg-[#eff3f41a]"
        >
          <svg viewBox="0 0 24 24" width={26.5} height={26.5}>
            <path
              fill="#fff"
          ...
          <div className="ml-4 text-xl font-bold">Para Kazanma</div>
        </Link>
        <Link
          to="/"
          className="w-full h-14 flex items-center px-4 hover:bg-[#eff3f41a]"
        >
          ...
          <div className="ml-4 text-xl font-bold">Pro</div>
        </Link>
        <Link
          to="/"
          className="w-full h-14 flex items-center px-4 hover:bg-[#eff3f41a]"
        >
          ...
          <div className="ml-4 text-xl font-bold">Reklamlar</div>
        </Link>
        <Link
          to="/"
          className="w-full h-14 flex items-center justify-between px-4 hover:bg-[#eff3f41a]"
        >
          <div className="flex items-center">
            ...
            <div className="ml-4 text-xl font-bold">İşler</div>
          </div>
          <div className="bg-[#491600] font-bold text-[13px] px-1 -mx-1 ">
            Beta
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div className="ml-4 text-xl font-bold">Ayarlar ve gizlilik</div>
        </Link>
      </Popover.Panel>
    </Popover>
  );
